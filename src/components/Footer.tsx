        ...
        <div className="footer">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul>
                        <li className="mb-2"><a href="https://facebook.com" className="text-white hover:text-lime-400"><MdOutlineFacebook/> Facebook</a></li>
                        <li className="mb-2"><a href="https://x.com" className="text-white hover:text-lime-400"><FaTwitter/> Twitter</a></li>
